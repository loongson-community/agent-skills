...
This project itself aims to guide AI agents more effectively, so rejecting AIGC within this project would be logically inconsistent. However, given the ongoing discussions around AIGC intellectual property, we believe it is necessary to give AIGC due consideration and maintain clear boundaries.
