...
- 必须为所有文档（项目级文档和技能文档）提供**中英文双语版本**，以最大化传播范围。
...
- 应在文档文件顶部添加 SPDX 许可证头（`<!-- SPDX-License-Identifier: ... -->`）。

### 中文写作风格

撰写中文内容时，应避免使用**主题—评述（topic-comment）句式**，
改用**主谓结构**并搭配适当的介词或助词，以便不同背景的读者
（尤其是可能不熟悉 LoongArch 术语的读者）更容易理解。

具体要求：

- **避免将主题直接充当主语而省略介词**，应使用"对于""为"
  "在"等介词明确语义关系。
- **无生命主语不要省略被动标记**（"被""由"等），或者改写为
  显式的主动句并补全隐含的宾语。
...
| 新世界工具链通常能正确自动检测 | 新世界工具链通常能被自动检测；或：新世界工具链通常能自动检测目标元组 |
